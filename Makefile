...
.PHONY: all mypy pyright ruff ruff-fix flake8 autopep8 autopep8-fix zizmor
...
check: ruff autopep8 flake8 mypy pyright zizmor
...
ruff ruff-fix autopep8 autopep8-fix flake8 mypy pyright zizmor:
	uv run prek -a $@
