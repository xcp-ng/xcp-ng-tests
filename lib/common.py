...
@overload
def callable_marker(value: Any, request: pytest.FixtureRequest, typ: None = None) -> Any:
    ...

@overload
def callable_marker(value: Any, request: pytest.FixtureRequest, typ: Type[T]) -> T:
    ...

def callable_marker(value: Any, request: pytest.FixtureRequest, typ: Union[None, Type[T]] = None) -> Union[Any, T]:
    """
