...
def test_parametrized_answerfile(answerfile: AnswerFile, parm: int) -> None:
...
class TestManualChaining:
    ...
    def test_create(self, create_vms: list[VM]) -> None:
    ...
    def test_chain(self, create_vms: list[VM]) -> None:
