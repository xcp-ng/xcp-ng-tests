...
class TestGuestToolsUnix:
    ...
    def _check_tools_version(self, vm: VM, tools_version: str) -> None:
    ...
    def _check_os_info(self, vm: VM, vm_distro: str) -> None:
    ...
    def test_check_tools(self, running_vm: VM, state: State) -> None:
        vm = running_vm
        assert state.tools_version is not None
        self._check_tools_version(vm, state.tools_version)
        assert state.vm_distro is not None
