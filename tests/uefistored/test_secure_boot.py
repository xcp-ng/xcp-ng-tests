...
@pytest.mark.small_vm # run most tests in the class with a small UEFI VM to test the features
...
@pytest.mark.small_vm # run with a small UEFI VM to test the features
