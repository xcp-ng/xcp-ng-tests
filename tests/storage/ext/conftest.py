...
@pytest.fixture()
def vdi_cbt_on_ext_sr(vdi_on_ext_sr: VDI) -> Generator[VDI, None, None]:
    """ A VDI on EXT SR with CBT enabled. """
    enable_cbt_with_wait(vdi_on_ext_sr)
    yield vdi_on_ext_sr
    disable_cbt_with_wait(vdi_on_ext_sr)
