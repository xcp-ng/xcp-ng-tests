...
# The aliases are required to map the hyphenated json keys from drbdsetup status --json (out-of-sync, peer-disk-state,
# peer-devices) to the Python fields. They are used implicitly by pydantic's validate_json
