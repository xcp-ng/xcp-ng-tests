...
def assert_performance_not_degraded(current, previous, regression_threshold=10, improvement_threshold=10):
    diffs = {}
...
class TestDiskPerf:
    ...
    def test_disk_benchmark(
        ...
        test_type = "bench-fio-{}-{}-{}-{}-{}-{}".format(block_size, file_size, 1, 1, rw_mode, vdi.get_image_format())
