...
class TestLocalISOSRReboot:
    ...
    def test_iso_mount_and_read_after_reboot(self, host, local_iso_sr, imported_vm):
        ...
        imported_vm.start()
        imported_vm.wait_for_os_booted()
        try:
            check_iso_mount_and_read_from_vm(host, os.path.basename(iso_path), imported_vm)
        finally:
            # SR cleaning
