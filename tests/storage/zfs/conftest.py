...
@pytest.fixture()
def vdi_cbt_on_zfs_sr(vdi_on_zfs_sr: VDI) -> Generator[VDI, None, None]:
    """ A VDI on ZFS SR with CBT enabled. """
    enable_cbt_with_wait(vdi_on_zfs_sr)
    yield vdi_on_zfs_sr
    disable_cbt_with_wait(vdi_on_zfs_sr)
