...
@pytest.fixture()
def vdi_cbt_on_xfs_sr(vdi_on_xfs_sr: VDI) -> Generator[VDI, None, None]:
    """ A VDI on XFS SR with CBT enabled. """
    enable_cbt_with_wait(vdi_on_xfs_sr)
    yield vdi_on_xfs_sr
    disable_cbt_with_wait(vdi_on_xfs_sr)
