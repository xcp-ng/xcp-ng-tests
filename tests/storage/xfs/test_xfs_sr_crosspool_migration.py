...
class Test:
    def test_cold_crosspool_migration(self, host: Host, hostB1: Host, vm_on_xfs_sr: VM, xfs_sr_on_hostB1: SR,
                                      image_format: ImageFormat) -> None:
        cold_migration_then_come_back(vm_on_xfs_sr, host, hostB1, xfs_sr_on_hostB1, image_format)

    def test_live_crosspool_migration(self, host: Host, hostB1: Host, vm_on_xfs_sr: VM, xfs_sr_on_hostB1: SR,
                                      image_format: ImageFormat) -> None:
        live_storage_migration_then_come_back(vm_on_xfs_sr, host, hostB1, xfs_sr_on_hostB1, image_format)
