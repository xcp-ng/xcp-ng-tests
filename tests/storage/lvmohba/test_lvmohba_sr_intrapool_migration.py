...
class Test:
    def test_live_intrapool_shared_migration(self, host: Host, hostA2: Host, vm_on_lvmohba_sr: VM) -> None:
    ...
    def test_cold_intrapool_migration(
        self, host: Host, hostA2: Host, vm_on_lvmohba_sr: VM, xfs_sr_on_hostA2: SR
    ) -> None:
