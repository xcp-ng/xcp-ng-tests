...
class Test:
    ...
    def test_cold_crosspool_migration(self, host: Host, hostB1: Host, dispatch_nfs: VM, local_sr_on_hostB1: SR):
        cold_migration_then_come_back(dispatch_nfs, host, hostB1, local_sr_on_hostB1)

    @pytest.mark.parametrize('dispatch_nfs', ['vm_on_nfs_sr', 'vm_on_nfs4_sr'], indirect=True)
    def test_live_crosspool_migration(self, host: Host, hostB1: Host, dispatch_nfs: VM, local_sr_on_hostB1: SR):
