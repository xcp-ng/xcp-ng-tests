...
@pytest.fixture()
def vdi_cbt_on_nfs_sr(vdi_on_nfs_sr: VDI) -> Generator[VDI, None, None]:
    """ A VDI on NFS SR with CBT enabled. """
    enable_cbt_with_wait(vdi_on_nfs_sr)
    yield vdi_on_nfs_sr
    disable_cbt_with_wait(vdi_on_nfs_sr)
