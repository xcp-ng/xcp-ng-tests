...
class Test:
    def test_live_intrapool_shared_migration(
        self, host, hostA2, vm_on_cephfs_sr, cephfs_sr
    ):
        live_storage_migration_then_come_back(
    ...
    def test_cold_intrapool_migration(
        self, host, hostA2, vm_on_cephfs_sr, cephfs_sr, local_sr_on_hostA2
    ):
        cold_migration_then_come_back(
            vm_on_cephfs_sr, host, cephfs_sr, hostA2, local_sr_on_hostA2
        )
