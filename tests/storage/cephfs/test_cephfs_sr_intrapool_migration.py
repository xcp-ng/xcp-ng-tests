...
class Test:
    def test_live_intrapool_shared_migration(self, host, hostA2_with_ceph, vm_on_cephfs_sr, cephfs_sr):
        live_storage_migration_then_come_back(vm_on_cephfs_sr, host, cephfs_sr, hostA2_with_ceph, cephfs_sr)
