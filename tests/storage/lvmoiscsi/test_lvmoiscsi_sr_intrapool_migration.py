...
class Test:
    ...
    def test_cold_intrapool_migration(self, host: Host, hostA2: Host, vm_on_lvmoiscsi_sr: VM, local_sr_on_hostA2: SR):
        cold_migration_then_come_back(vm_on_lvmoiscsi_sr, host, hostA2, local_sr_on_hostA2)

    def test_live_intrapool_migration(self, host: Host, hostA2: Host, vm_on_lvmoiscsi_sr: VM, local_sr_on_hostA2: SR):
