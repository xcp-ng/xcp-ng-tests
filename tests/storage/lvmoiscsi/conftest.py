...
@pytest.fixture()
def vdi_on_lvmoiscsi_sr(lvmoiscsi_sr: SR, image_format: ImageFormat) -> Generator[VDI, None, None]:
    vdi = lvmoiscsi_sr.create_vdi('lvmoiscsi-VDI-test', virtual_size=config.volume_size(image_format))
    yield vdi
    vdi.destroy()
